...
uncleanedhouseprices = read_csv('D:/DataScienceAssignment/cleaned datasets/Combined_House_Pricing_2019-2022.csv')
...
write.csv(FilteredTown, "D:/DataScienceAssignment/cleaned datasets/Cleaned_Town_population.csv",row.names = FALSE)
